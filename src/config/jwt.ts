...
export const jwtConfig = registerAs(
  ...
  (): JwtConfig => ({
    ...
    accessExpiresIn: process.env.JWT_ACCESS_EXPIRES_IN as StringValue | undefined,
    refreshExpiresIn: process.env.JWT_REFRESH_EXPIRES_IN as StringValue | undefined,
