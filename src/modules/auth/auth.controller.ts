...
import { CreateUserDto, UserLoginDto, LoginResponseDto } from "../../common/entity-dto";
import {
  Serialize,
  TransactionManager,
  SwaagerApiTags,
...
export class AuthController {
  ...
  async getLoginGoogleCallback(
    ...
    const data = await this.authService.loginGoogle(res, transactionManager, code);
  ...
  async getLoginNaverCallback(
    ...
    const data = await this.authService.loginNaver(res, transactionManager, code, state);
